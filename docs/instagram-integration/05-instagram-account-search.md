...
- 「公式と思われる」かどうかは、次の条件で判断する:
  - 検索結果のスニペットや、Instagramのプロフィール文に
    - 施設名（例: ゆるまる）
...
- ファイル: `docs/instagram-integration/04-runbook.md` の「登録記録」セクションに、施設ごとに1行を追加する。
- **記録すべき内容**:
  - 施設名
  - InstagramアカウントURL
  - 投稿形式（まだ見ていなければ「未確認」でOK）
  - スケジュールURL（今回未対応なら「未確認」）
  - 登録日
  - 備考（使用クエリ、公式と判断した根拠、フォロワー数 など）

**例**:

| 施設名   | InstagramアカウントURL                              | 投稿形式 | スケジュールURL | 登録日     | 備考                                                                 |
|----------|------------------------------------------------------|---------|----------------|------------|----------------------------------------------------------------------|
| ゆるまる | https://www.instagram.com/yurumaru_nakagawa/        | 未確認  | 未確認         | 2025-11-26 | Google検索「ゆるまる instagram」で最初に表示。説明文に中川区子育て応援拠点と明記。フォロワー1400人以上 |
...
- [04-runbook.md](./04-runbook.md) - 運用手順書（登録記録の記録場所）
