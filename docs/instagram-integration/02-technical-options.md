...
- **詳細ページにもInstagramリンクが含まれていない**（サンプル3件を確認）
...
1. **InstagramアカウントURLの取得**:
   - **方法A（推奨・採用）**: 手動で調査・登録
     ...
     - **調査結果**: 詳細ページにもInstagramリンクが含まれていないため、手動調査が必須
   - **方法B（非推奨）**: 詳細ページ経由のスクレイピング
     - **調査結果により、詳細ページにInstagramリンクが含まれていないことが判明**
     - スクレイピングスクリプトの拡張は現時点では不要
...
1. ~~**詳細ページの確認**~~ ✅ **完了**（2025-01-22）
   - サンプル3件の詳細ページを確認し、Instagramリンクが含まれていないことを確認
