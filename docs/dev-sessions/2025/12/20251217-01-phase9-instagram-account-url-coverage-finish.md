...
- 一言サマリ: クエリ改善・自動判定・レビュー運用を固めて、**全施設のInstagram URL取得・更新を終わらせる**
- 対応フェーズ: フェーズ9
...
- [ ] タスク1: `no_candidates` 削減のための検索クエリ改善（括弧/揺れ・必要ならフォールバック本数）を仕上げる
  - 完了条件:
...
- [ ] タスク2: CLIで「自動更新できるものは更新」し、複数候補/未特定をレビューに回して全体を完走する
  - 完了条件:
...
- [ ] タスク3: フェーズ9の進捗・Runbook・品質チェックを更新してクローズ条件に近づける
  - 完了条件:
