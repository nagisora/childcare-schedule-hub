...
- **検証方法**: どのコマンド/どの画面で確認するか（**重要**: 人間が間違えるようにAIも間違えます。クリティカルな障害を防ぐため、各タスクでは必ずテストとエラー検知を実施してください）
...
> **重要**: 人間が間違えるようにAIも間違えます。クリティカルな障害を防ぐため、データ品質チェックとエラー検知は必ず実施してください。自動化されたチェックと手動確認を組み合わせて、問題を早期に発見できるようにしてください。
